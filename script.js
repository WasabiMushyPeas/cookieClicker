...
// function that looks at the difference between cookies 1 second ago and now and calculates the cookies per second that runs in the background
function cookiesPerSecondLoop() {
    let cookiesPerSecondTemp = cookies;
    setTimeout(function () {
        cookiesPerSecond = cookies - cookiesPerSecondTemp;
        updateCookiesPerSecond();
        saveGame();
        cookiesPerSecondLoop();
    }, 1000);
